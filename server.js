...
if (currentMenuV !== MENU_V) {
  ...
  const seed = [
    ...
    ['batch2','coffee','🫖','Батч брю 200','Заварили с любовью. Кислит, сладит, живёт',['фильтр-кофе'],'200 мл',220,'',1],
    ['batch3','coffee','🫖','Батч брю 300','Заварили с любовью. Кислит, сладит, живёт',['фильтр-кофе'],'300 мл',260,'',1],
    ['flat','coffee','☕','Флэт уайт','Двойной эспрессо в бархатной накидке',['двойной эспрессо','молоко'],'180 мл',280,'',1],
    ['cap2','coffee','☕','Капучино 200','Классика, за которой возвращаются. Пенка — хоть рисуй',['эспрессо','молоко'],'200 мл',250,'Хит',1],
    ['cap3','coffee','☕','Капучино 300','Классика, за которой возвращаются. Пенка — хоть рисуй',['эспрессо','молоко'],'300 мл',340,'',1],
    ['lat3','coffee','🥛','Латте 300','Мягкий и тёплый, как объятие. Только вкуснее',['эспрессо','молоко'],'300 мл',310,'',1],
    ['lat4','coffee','🥛','Латте 400','Мягкий и тёплый, как объятие. Только вкуснее',['эспрессо','молоко'],'400 мл',360,'',1],
    ['raf3','coffee','🍦','Раф 300','Сливочный, сладкий, затягивает. Мы никому не расскажем',['эспрессо','сливки','ванильный сахар'],'300 мл',360,'',1],
    ['raf4','coffee','🍦','Раф 400','Сливочный, сладкий, затягивает. Мы никому не расскажем',['эспрессо','сливки','ванильный сахар'],'400 мл',400,'',1],
    ['matcha3','drinks','🍵','Маття 300','Зелёный, полезный, фотогеничный. Энергия без кофе',['маття','молоко'],'300 мл',290,'',0],
    ['matcha4','drinks','🍵','Маття 400','Зелёный, полезный, фотогеничный. Энергия без кофе',['маття','молоко'],'400 мл',360,'',0],
    ['cocoa3','drinks','🍫','Какао 300','Из детства, с маршмеллоу и без сожалений',['какао','молоко','маршмеллоу'],'300 мл',290,'',0],
    ['cocoa4','drinks','🍫','Какао 400','Из детства, с маршмеллоу и без сожалений',['какао','молоко','маршмеллоу'],'400 мл',370,'',0],
